...
$(document).ready(function(){
	...
	$('.twitterWidget ul').twitter('rubenbristian', 3);

	$('.post').append('<span class="bullet"></span>');

	$('.socialIcons').each(function(){
		$(this).css({'marginLeft': -Math.round($(this).width()/2), 'paddingLeft': '50%'});
	});
	...
	function doLayers(){
		$('#home #back').animate({'opacity': 1}, 600);
